...
urlpatterns = [
    ...
    path('reset_password/', auth_views.PasswordResetView.as_view(template_name="registro/password_reset_form.html", email_template_name="registro/password_reset_email.html"), name="password_reset"),
    path('reset_password/done/', auth_views.PasswordResetDoneView.as_view(template_name="registro/password_reset_done.html"), name="password_reset_done"),
